...
public class MediaMovelPonderadaTest {
	...
	public void sequenciaSimplesDeCandles(){
		...
		Assert.assertEquals(20.0/6, mmp.calcula(2, serie), 0.00001);
		Assert.assertEquals(26.0/6, mmp.calcula(2, serie), 0.00001);
		Assert.assertEquals(32.0/6, mmp.calcula(2, serie), 0.00001);
	}
}
